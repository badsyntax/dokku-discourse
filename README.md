...
*Note: A new docker image will be built and this process can take some time.*
...
*Note: The running discourse app will be stopped and the docker image will be rebuilt.*
